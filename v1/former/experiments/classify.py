...
def go(arg):
    ...
    print('embedding size ', arg.embedding_size)
    print('num heads ', arg.num_heads)
    print('depth ', arg.depth)
    print('seq length ', mx)
    print('vocab size ', arg.vocab_size)
    print('num classes ', NUM_CLS)
    print('max pool ', arg.max_pool)    
